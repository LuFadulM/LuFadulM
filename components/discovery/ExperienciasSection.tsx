  ...
  return (
    <button
      ...
      style={{
        ...
        width: "32px",
        height: "32px",
        background: disabled ? "rgba(236,243,238,0.03)" : "rgba(236,243,238,0.07)",
        border: `1px solid ${disabled ? "rgba(236,243,238,0.06)" : "rgba(236,243,238,0.12)"}`,
        borderRadius: "6px",
        cursor: disabled ? "default" : "pointer",
        transition: "all 0.2s ease",
        flexShrink: 0,
        color: disabled ? "rgba(236,243,238,0.18)" : "rgba(236,243,238,0.65)",
      }}
      onMouseEnter={(e) => {
        if (!disabled) {
          (e.currentTarget as HTMLButtonElement).style.background = "rgba(61,220,151,0.10)";
          (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(61,220,151,0.28)";
          (e.currentTarget as HTMLButtonElement).style.color = "#3DDC97";
        }
      }}
      onMouseLeave={(e) => {
        if (!disabled) {
          (e.currentTarget as HTMLButtonElement).style.background = "rgba(236,243,238,0.07)";
          (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(236,243,238,0.12)";
          (e.currentTarget as HTMLButtonElement).style.color = "rgba(236,243,238,0.65)";
        }
      }}
    >
      <svg
    ...
    <div ref={ref} style={{ position: "relative", flexShrink: 0 }}>
      <button
        ...
        style={{
          ...
          background: isActive ? "rgba(61,220,151,0.10)" : "rgba(236,243,238,0.06)",
          color: isActive ? "#3DDC97" : "rgba(236,243,238,0.65)",
          border: isActive ? "1px solid rgba(61,220,151,0.28)" : "1px solid rgba(236,243,238,0.07)",
          borderRadius: "6px",
          cursor: "pointer",
          transition: "all 0.2s ease",
          whiteSpace: "nowrap",
      ...
      >
        ...
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"
          aria-hidden="true"
          style={{ transition: "transform 0.2s ease", transform: open ? "rotate(180deg)" : "rotate(0deg)", opacity: 0.6, flexShrink: 0 }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: isSel ? "#3DDC97" : "rgba(236,243,238,0.65)",
                  background: isSel ? "rgba(61,220,151,0.10)" : "transparent",
                  border: "none", borderRadius: "4px", cursor: "pointer", textAlign: "left",
                  transition: "background 0.15s, color 0.15s",
                }}
                onMouseEnter={(e) => { if (!isSel) (e.currentTarget as HTMLButtonElement).style.background = "rgba(236,243,238,0.06)"; }}
                onMouseLeave={(e) => { if (!isSel) (e.currentTarget as HTMLButtonElement).style.background = "transparent"; }}
              >
                {city}
                {isSel && (
                  <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#3DDC97" strokeWidth="2.5" aria-hidden="true">
...
// ─── Event card — full-overlay cinematic ──────────────────────────────────────
    ...
    <Link href={`/experiences/${event.slug}`} className="block group">
      <article
        ...
        style={{
          ...
          boxShadow: hovered
            ? "0 28px 60px rgba(0,0,0,0.45), 0 0 0 1px rgba(61,220,151,0.10)"
      ...
      >
        ...
        {event.cover_image_url ? (
          ...
          <div
            ...
            style={{ background: "linear-gradient(135deg, #12241B 0%, #0C1912 50%, #07120D 100%)" }}
          />
        )}
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(0,0,0,0.96) 0%, rgba(0,0,0,0.60) 42%, rgba(0,0,0,0.12) 72%, transparent 100%)",
          }}
        />

        {/* Top row: category + timing badge */}
          ...
          {(event.duration_label || event.price_level) && (
            <div className="flex items-center gap-4">
              {event.duration_label && (
                ...
                >
                  <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" style={{ opacity: 0.5 }}>
              ...
              {event.price_level && (
                <span style={{ fontSize: "9px", letterSpacing: "0.1em", color: "rgba(61,220,151,0.7)", fontFamily: "'Sora', system-ui, sans-serif", fontWeight: 600 }}>
                  {event.price_level}
                </span>
              )}
              <span
  ...
  return (
    <Link href={`/experiences/${event.slug}`} className="block group">
      <div
        ...
        style={{ padding: "14px 0", borderBottom: "1px solid rgba(236,243,238,0.07)" }}
      >
        <div
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3DDC97" strokeWidth="1.5" aria-hidden="true">
            <circle cx="12" cy="12" r="10" />
            <polyline points="12 6 12 12 16 14" />
          </svg>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <p
            className="font-serif leading-snug transition-colors duration-200 group-hover:text-[#EFF4EE]"
            style={{ fontSize: "14px", color: "#EFF4EE" }}
          >
            {event.title}
          </p>
          <p
          ...
          >
            {event.timing_label}
            <span style={{ color: "rgba(236,243,238,0.18)", margin: "0 6px" }}>·</span>
            {event.city}
          </p>
        </div>
...
export default function ExperienciasSection({ events }: ExperienciasSectionProps) {
  ...
  const main = events.filter(
    (e) =>
      (e.bucket === "experiencias" || e.bucket === "planes") &&
      (activeCity === "Todas" || e.city === activeCity)
  );

  const recurrentes = events.filter(
    (e) => e.bucket === "recurrentes" && (activeCity === "Todas" || e.city === activeCity)
  );
  ...
  return (
    <section className="mb-32">
      ...
      {main.length > 0 ? (
        <div style={{ position: "relative", marginBottom: "44px" }}>
          ...
          <div
            ...
            style={{
              ...
              background: "linear-gradient(to right, transparent, #07120D 90%)",
              pointerEvents: "none",
          ...
          <div
            ...
            style={{
              ...
              background: "linear-gradient(to left, transparent, #07120D 90%)",
              pointerEvents: "none",
        ...
        <div style={{ padding: "40px 0", textAlign: "center", color: "rgba(236,243,238,0.35)", fontSize: "13px", fontWeight: 300, marginBottom: "40px" }}>
      ...
      {recurrentes.length > 0 && (
        <div>
          <div className="flex items-center gap-3 mb-4">
            <span className="label-micro" style={{ color: "rgba(236,243,238,0.65)" }}>Pasa cada semana</span>
            <div style={{ flex: 1, height: "1px", background: "rgba(236,243,238,0.07)" }} />
          </div>
