...
function derivePlan(place: Place): { planTitle: string; planMoment: string; momentColor: string; momentBg: string; emoji: string } {
  ...
  if (place.category === "Cafés") return {
    ...
    planMoment: "Mañana", momentColor: "#3DDC97",
    momentBg: "rgba(61,220,151,0.16)", emoji: "☕",
  };
  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${disabled ? "rgba(236,243,238,0.04)" : "rgba(236,243,238,0.12)"}`,
        borderRadius: "50%",
        cursor: disabled ? "default" : "pointer",
        transition: "all 0.2s ease",
        color: disabled ? "rgba(236,243,238,0.15)" : "rgba(236,243,238,0.65)",
      }}
      onMouseEnter={(e) => {
        if (!disabled) {
          (e.currentTarget as HTMLButtonElement).style.background = "#3DDC97";
          (e.currentTarget as HTMLButtonElement).style.borderColor = "#3DDC97";
    ...
    <Link href={`/places/${place.slug}`} className="block">
      <article
        style={{
          ...
          boxShadow: hovered
            ? "0 20px 50px rgba(0,0,0,0.45), 0 6px 20px rgba(0,0,0,0.35)"
      ...
      <div style={{
        ...
        <div>
          <p style={{
            ...
            fontWeight: 700, fontFamily: "'Sora', system-ui, sans-serif",
            color: "#3DDC97", marginBottom: "8px",
            display: "flex", alignItems: "center", gap: "8px",
          }}>
            <span style={{ display: "inline-block", width: "18px", height: "1px", background: "#3DDC97" }} />
            Para ti
          </p>
          <h2 className="font-serif" style={{
            fontSize: "clamp(36px, 5vw, 62px)",
            color: "#EFF4EE", fontWeight: 400, letterSpacing: "-0.02em",
          }}>
            Pequeños planes
          </h2>
          <p style={{
            fontSize: "13px", color: "rgba(236,243,238,0.65)",
