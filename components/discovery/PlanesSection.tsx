  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${disabled ? "rgba(245,240,232,0.04)" : "rgba(245,240,232,0.12)"}`,
        borderRadius: "50%",
        cursor: disabled ? "default" : "pointer",
        transition: "all 0.2s ease",
        color: disabled ? "rgba(245,240,232,0.15)" : "rgba(245,240,232,0.65)",
      }}
      onMouseEnter={(e) => {
        if (!disabled) {
      ...
      <div style={{
        ...
        <div>
          <p style={{
            ...
            <span style={{ display: "inline-block", width: "18px", height: "1px", background: "#C9A84C" }} />
            Para ti
          </p>
          <h2 className="font-serif" style={{
            fontSize: "clamp(36px, 5vw, 62px)",
            color: "#F5F0E8", fontWeight: 400, letterSpacing: "-0.02em",
          }}>
            Pequeños planes
          </h2>
          <p style={{
