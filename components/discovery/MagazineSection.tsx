      ...
      >
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "32px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#3DDC97" strokeWidth="2"
    ...
    <Link href={`/places/${story.place.slug}`} className="block group h-full">
      <article
        style={{
          ...
          boxShadow: hovered
            ? "0 18px 48px rgba(0,0,0,0.45), 0 4px 16px rgba(0,0,0,0.35)"
      ...
      >
        {story.place.cover_image_url ? (
          ...
          <div style={{ position: "absolute", inset: 0, background: "#12241B" }} />
        )}
    ...
    <section>
      ...
      <div style={{
        ...
        <div>
          ...
          <h2 className="font-serif" style={{ fontSize: "clamp(36px, 5vw, 62px)", color: "#EFF4EE", fontWeight: 300, letterSpacing: "-0.03em", lineHeight: "1.05" }}>
            Colombia en historias
          </h2>
          <p style={{ fontSize: "13px", color: "rgba(236,243,238,0.65)", fontFamily: "'Sora', system-ui, sans-serif", fontWeight: 300, marginTop: "6px" }}>
