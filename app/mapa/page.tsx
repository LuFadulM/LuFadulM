...
export default function MapaPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-16 sm:py-20">
      ...
      <p style={{ color: "#64756B", fontSize: "14px", lineHeight: "1.8", maxWidth: "520px" }}>
        {p.body}
      </p>
      <Link
        href="/"
        className="inline-block mt-10"
        style={{ fontSize: "11px", letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 500, color: "#3DDC97" }}
      >
        {p.back}
      </Link>
    </main>
